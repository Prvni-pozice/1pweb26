...
- [x] 2026-07-28 — **Měření konverzí formuláře** hotové: serverový záznam bez osobních údajů, dashboard `/api/statistiky`, týdenní e-mail. Viz `MERENI-A-REPORT.md`.
...
- [ ] **Měsíční údržbový report** — audit závislostí, rozbité odkazy a build. Týdenní report už hlásí verze Astra; tohle by ho doplnilo o zbytek.
